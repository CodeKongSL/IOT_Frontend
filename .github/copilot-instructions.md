...
- [x] Clarify Project Requirements (React + Vite + Tailwind IoT dashboard)
	<!-- Ask for project type, language, and frameworks if not specified. Skip if already provided. -->

- [x] Scaffold the Project (Vite React scaffolded)
	<!--
...
- [x] Customize the Project (Dashboard UI, hooks, services, and styling added)
	<!--
